...
(def matrix-tests
  '( [matrix-20 (path-finder 5 4 '(7 2 7 10 7 5 7 10 5 8 4 2 1 4 3 3 9 8 5 9)) => '{:path (1 4 3 2), :total 10}]
     [matrix-25 (path-finder 5 5 '(6 1 2 10 3 9 4 9 8 8 7 4 1 3 6 7 2 1 10 5 10 9 2 8 2)) => '{:path (7 2 1 3 5), :total 18}]
     [matrix-100 (path-finder 10 10 '(4 9 6 3 7 1 2 6 10 2 7 2 7
                                       ...
                                       4 10 6 9 2 4 10)) => '{:path (3 3 1 1 2 1 3 1 2 1), :total 18}]
     [matrix-30-1 (path-finder 2 15 '(9 2 4 10 1 3 2 1 3 5 7 1 10 2 1 7 5 4 4 9 6 3 9 10 2 2 4 6 2 2)) => '{:path (7 2 4 4 1 3 2 1 3 2 2 1 6 2 1), :total 41}]
     [matrix-30-2 (path-finder 5 6 '(9 2 4 10 1 3 2 1 3 5 7 1 10 2 1 7 5 4 4 9 6 3 9 10 2 2 4 6 2 2)) => '{:path (2 1 1 3 2 2), :total 11}]
     [matrix-50 (path-finder 10 5 '(4 3 5 8 2 9 4 5 5 3 6 7 3 8 4 8 6 8 7 10 1 5 4 3 10 10 1 8 1 3 9
                                     3 6 10 8 8 4 4 9 2 10 9 4 3 9 6 8 10 10 6)) => '{:path (1 1 4 1 3), :total 10}]
     [matrix-30-3 (path-finder 15 2 '(5 7 3 9 8 2 8 10 10 2 10 3 8 8 6 2 7 2 10 4 1 10 10 1 5 6 3 9 4 3)) => '{:path (1 1), :total 2}]
     [matrix-45 (path-finder 5 9 '(8 6 3 7 1 7 6 1 6 9 9 7 5 8 1 4 9 7 8 1 6 5 4 1 2 4 2 9 4 1 9 3 2 3 1 10 1 3 5 1 2 5 7 10 3)) => '{:path (1 3 1 1 1 1 2 1 2), :total 13}]
     ...
     [matrix-1000 (path-finder 10 100 '(10 9 8 3 5 3 9 10 8 1 10 9 1 6 3 3 1 5 5 6 5 9 6 9 2 6 8 10 1 9 10 6 1 8 8 9 4 1 3 5 1 3 2 9 2 2 4 10 3 10 7 8 3 9 8 9 10 6 5 8 5 2 9 8 8 4
      ...
      => '{:path (1 5 1 5 3 5 3 1 1 1 3 8 1 4 3 3 1 2 3 6 3 4 1 1 1 1 6 4 1 2 1 1 1 1 8 5 2 1 3 5 1 3 2 1 2 2 2 2 3 5 3 3 3 2 6 7 4 5 3 1 5 2 3 3 6 3 6 1 1 1 2 6 1 2 2 5 4 2 6 1 4 3 2 1 1 3
                   2 1 5 2 1 2 1 1 1 1 2 5 5 5),   :total 282}]
